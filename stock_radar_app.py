...
def generate_pdf(result):
    """Generar PDF - Pendiente de implementación"""
    st.warning("⚠️ Generación PDF temporalmente deshabilitada. Usa el análisis en pantalla o cópialo manualmente.")
    return None
        ...
        if not api_key:
            ...
            with st.spinner("🔍 Analizando mercado (30-60s)..."):
                ...
                if analisis:
                    ...
                    c1, c2 = st.columns(2)
                    with c1:
                        # Opción de copiar texto
                        st.text_area("📋 Copiar análisis:", analisis, height=200, key="copy_swing")
                ...
                if not api_key:
                    ...
                    with st.spinner("🔍 Analizando..."):
                        ...
                        if analisis:
                            ...
                            with c1:
                                # Opción de copiar texto
                                st.text_area("📋 Copiar análisis:", analisis, height=200, key="copy_port")
